...
namespace PuzzleMania.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<PuzzleManiaUser> _signInManager;
        private readonly UserManager<PuzzleManiaUser> _userManager;
        private readonly IUserStore<PuzzleManiaUser> _userStore;
        ...
        private PuzzleManiaUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<PuzzleManiaUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(PuzzleManiaUser)}'. " +
                    $"Ensure that '{nameof(PuzzleManiaUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<PuzzleManiaUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<PuzzleManiaUser>)_userStore;
        }
    }
}
